...
function addClassification($newClassificationName)
{
    // Create a connection object using the phpmotors connection function
    $db = phpmotorsConnect();
    // The SQL statement
    $sql = 'INSERT INTO carclassification (classificationName)
        VALUES (:newClassificationName)';
    // Create the prepared statement using the phpmotors connection
    $stmt = $db->prepare($sql);
    // The next four lines replace the placeholders in the SQL
    // statement with the actual values in the variables
    // and tells the database the type of data it is
    $stmt->bindValue(':newClassificationName', $newClassificationName, PDO::PARAM_STR);
    // Insert the data
    $stmt->execute();
...
// this function will update vehicle
...
// this function will obtain information about all vehicles in inventor
